...
export default function ElectronicInvoicesPage() {
  return (
    <div className="p-8">
      ...
      <p className="text-white/50 mb-8">Conformité réforme facture électronique 2026.</p>
      <div className="bg-white/[0.03] border border-white/[0.07] rounded-2xl p-12 text-center">
        <div className="text-5xl mb-4">⚡</div>
        <h2 className="text-xl font-semibold text-white mb-2">Disponible en 2026</h2>
        <p className="text-white/40">Ce module sera activé lors du déploiement de la réforme obligatoire.</p>
      </div>
    </div>
  )
}
